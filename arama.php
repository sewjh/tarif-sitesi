...
<body>
    <center>
        ...
        <div class="main-box">
            <center>
                <div class="lineBox">
                    <h1 class="baslik">Arama Sonucu</h1>
                </div>
                <div class="tarifBilgileri">
                    ...
                    if (isset($_POST['ara'])) {
                        ...
                        $aramaSonucu = $_POST['ara'];

                        $select = "SELECT * FROM tarif where tarif_baslik like '%" . $aramaSonucu . "%'";
                        ...
                        echo "<b style='color:white;'>Arama başarısız.</b>";
                    }
                    ?>
                </div>
            </center>
