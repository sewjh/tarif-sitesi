                ...
                <form enctype="multipart/form-data" action="" method="POST">
                    <table class="tarifEkle">
                        ...
                        <tr>
                            ...
                            <td><textarea name="aciklama" class="inputLogin" rows="4" cols="50" required></textarea></td>
                        </tr>
                        <tr>
                            <td>Tarif Türü:</td>
                            <td>
                        ...
                        <tr>
                            <td>Tarif Görseli:</td>
                            <td><input type="FILE" style="border-radius: 7px; background-color: white; color: black;" name="dosya" required></td>
                        </tr>
                        <tr>
                            <td>Tarif Malzemeleri:</td>
                            <td>
                                <input type="text" name="malzeme" class="inputLogin" style="width: 500px;" required>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
...
if (isset($_POST["yukle"])) {
    ...
    $add = "INSERT INTO tarif (tarif_baslik, tarif_aciklama, tarif_gorsel, tarif_yazar, tarif_tur, tarif_malzeme) VALUES ('".$tarifBaslik."','".$tarifAciklama."','".$tarifGorsel."','".$tarifYazar."','".$tarifTur."','".$tarifMalzeme."')";
