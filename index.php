        ...
        <div class="main-box">
            <center>
                ...
                <?php
                    ...
                    $select = "SELECT * FROM tarif ORDER BY tarif_tarih DESC ";
                    ...
                    while ($row = $selectResult->fetch()) {
                        ...
                        <div class="tarifIcerik"><div class="tarifBaslik">' . $row["tarif_baslik"] . '</div></a>
                        <div class="tarifMalzemeler">';
                            ...
                            foreach ($malzemeListesi as $malzeme) {
                                ...
                                echo '<abbr title="'.$malzeme["malzeme_adi"].'"><img style="margin: 1px;" src="yuklenendosyalar/malzemeler/' . $malzeme['malzeme_gorsel'] . '" height="25" class="tarifMalzemeGorsel"></abbr>';
                            }}}
                            echo '</div></div></div>';
                        }
                    }
